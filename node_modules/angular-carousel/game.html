...
<html ng-app="DemoApp">
    <head>
        ...
        <link href='../../public/stylesheets/angular-carousel.css' rel='stylesheet' type='text/css'>
        ...
        .carousel-demo-game ul[rn-carousel] {
            overflow:hidden;
            width:25%;
            height:25%;
            margin:0;
    ...
    <body ng-controller="DemoCtrl">
        <div class="carousel-demo-game">
            <ul ng-repeat="carousel in carousels" rn-carousel rn-carousel-transition="hexagon" rn-carousel-buffered class="carousel1">
    ...
    <script src="../../public/javascripts/vendors/angular-carousel.min.js"></script>
